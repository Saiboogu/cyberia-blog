...
echo '<tr class="arise-toc-tr"><td class="arise-toc-td"><a href="'"$relative_url"'">'"$published_date"'</a></td><td class="arise-toc-td"><a href="'"$relative_url"'">'"$title"'</a></td><td class="arise-toc-td-desc"><a href="'"$relative_url"'">'"$description"'</a></td></tr>' >> $toc_tmp
clear_metadata
done
