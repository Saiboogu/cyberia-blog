...
echo '<tr class="arise-toc-tr"><td class="arise-toc-td">'"$published_date"'</td><td class="arise-toc-td"><a href="'"$relative_url"'">'"$title"'</a></td><td class="arise-toc-td-desc">'"$description"'</td></tr>' >> $toc_tmp
clear_metadata
done
